...
let foodArray = ['pizza', 'tacos', 'salad', 'ramen', 'blueberries'];
...
foodArray.unshift('apples');
console.log(`Added food to the start of my list: ${foodArray}`);
...
console.log('The updated list is', foodArray);

// 4.e (STRETCH) TODO: Replace the second food in your array
//      with another one of your favorite foods.
//      Then log the updated array.
foodArray[1] = 'pickles';
console.log('My food list is now', foodArray);

// 4.f (STRETCH) TODO: Sort your favoriteFoods array
//     in reverse alphabetical order. Log the array.
foodArray.sort();
foodArray.reverse();
console.log('My foods in reverse alphabetical order are', foodArray);
